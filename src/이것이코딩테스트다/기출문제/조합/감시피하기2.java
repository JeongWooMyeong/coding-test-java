...
public class 감시피하기2 {
    ...
    public static char[][] board = new char[6][6];  //복도 정보 (NxN)
    public static ArrayList<Position> teachers = new ArrayList<>(); //모든 선생님 위치 정보
    public static ArrayList<Position> spaces = new ArrayList<>();   //모든 빈공간 위치 정보
    ...
    public static void main(String[] args){
        ...
        //학생이 한명도 감지되지 않도록 설치할 수 있는지의 ㅇ부
        boolean found = false;
