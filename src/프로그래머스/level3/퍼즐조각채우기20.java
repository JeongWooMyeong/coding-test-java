...
public class 퍼즐조각채우기20 {
    ...
    static boolean match(List<int[]> p1, List<int[]> p2){
        ...
        p1.sort((a,b)->a[0] == b[0] ? Integer.compare(a[1],b[1]) : Integer.compare(a[0],b[0]));
        p2.sort((a,b)->a[0] == b[0] ? Integer.compare(a[1],b[1]) : Integer.compare(a[0],b[0]));
